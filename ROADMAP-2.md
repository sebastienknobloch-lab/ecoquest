...
Alimenté chaque semaine par la tâche d'audit automatique (voir `cowork-audit-hebdo-ecoquest.md`). Les constats validés deviennent des items numérotés `A1`, `A2`… traités en priorité sur les nouvelles fonctionnalités.
